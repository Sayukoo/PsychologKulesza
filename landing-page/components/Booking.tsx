    ...
    <section id="booking" className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-slate-50 border-t border-slate-200">
      <FadeIn>
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-[var(--color-primary)] font-serif tracking-tight mb-4 md:mb-6">Umów konsultację</h2>
          ...
          <div className="bg-white p-4 md:p-6 rounded-2xl shadow-2xl shadow-primary/10 min-h-[400px] border border-slate-200 transition-all duration-500 hover:shadow-primary/20">
